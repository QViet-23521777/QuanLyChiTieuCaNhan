    ...
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        <ScrollView contentContainerStyle={{alignItems: 'center'}} showsVerticalScrollIndicator={false}>
          ...
          <TextInput style={styles.input} placeholder="example@example.com" placeholderTextColor="#A0AFC0" />
          <Text style={styles.label}>Email</Text>
          <TextInput style={styles.input} placeholder="example@example.com" placeholderTextColor="#A0AFC0" />
          <Text style={styles.label}>Số điện thoại</Text>
          <TextInput style={styles.input} placeholder="123 456 789" placeholderTextColor="#A0AFC0" keyboardType="phone-pad" />
          <Text style={styles.label}>Ngày sinh</Text>
          <TextInput style={styles.input} placeholder="DD / MM / YYYY" placeholderTextColor="#A0AFC0" />
          ...
          <Text style={styles.terms}>
            ...
            <Text style={styles.termsLink}>Điều khoản sử dụng</Text> và <Text style={styles.termsLink}>Chính sách quyền riêng tư</Text>.
          </Text>
          ...
          <View style={styles.bottomRow}>
            ...
            <Link href="/" style={styles.loginLink}>Đăng nhập</Link>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  label: { alignSelf: 'flex-start', color: '#222', fontWeight: 'bold', marginTop: 12, marginBottom: 4 },
  input: {
  ...
  terms: { color: '#222', fontSize: 13, textAlign: 'center', marginVertical: 10 },
  ...
  loginLink: { color: '#4A90E2', fontWeight: 'bold', fontSize: 15, textDecorationLine: 'underline' },
});
