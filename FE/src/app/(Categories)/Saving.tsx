  ...
  return (
    <Outline>
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
        ...
        <Text style={styles.header}>Tiết Kiệm</Text>
        <View style={{ flex: 1 }} />
      </View>
        ...
        {filteredExpenses.map(exp => (
          <View key={exp.id} style={styles.expenseRow}>
            <View style={styles.iconCircle}>
              <FontAwesome5 name="piggy-bank" size={28} color="#fff" />
            </View>
      ...
      <TouchableOpacity
        style={styles.addBtn}
        onPress={() => router.push('/Categories/AddExpense?defaultCategory=Tiết%20Kiệm')}
      >
