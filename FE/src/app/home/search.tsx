...
const mockData = [
  { id: 1, type: 'Chi', category: 'Mua Sắm', date: '2025-05-20', time: '17:00', amount: 500000 },
  { id: 2, type: 'Thu', category: 'Thu Nhập', date: '2025-04-30', time: '18:27', amount: 7500000 },
];
  ...
  return (
      ...
      <View style={styles.radioGroup}>
        {['Thu', 'Chi'].map(type => (
          ...
          >
            <View style={[styles.radioCircle, reportType === type && styles.radioSelected]} />
          ...
          renderItem={({ item }) => (
            <View style={styles.resultItem}>
              ...
              <View style={styles.itemInfo}>
                ...
                <Text style={styles.itemTime}>{item.time} - {new Date(item.date).toLocaleDateString('vi-VN')}</Text>
              </View>
              <Text style={[styles.amount, item.type === 'Chi' ? styles.red : styles.blue]}>
...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: '#fff', padding: 10, borderRadius: 12, marginBottom: 10 },
  ...
  radioCircle: {
    width: 16, height: 16, borderRadius: 8, borderWidth: 1, borderColor: '#555', marginRight: 6,
  },
