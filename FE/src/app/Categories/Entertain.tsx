  ...
  return (
    <Outline>
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
        ...
        <Text style={styles.header}>Giải Trí</Text>
        <View style={{ flex: 1 }} />
      </View>
        ...
        {filteredExpenses.map(exp => (
          <View key={exp.id} style={styles.expenseRow}>
            <View style={styles.iconCircle}>
              <MaterialIcons name="sports-esports" size={28} color="#fff" />
            </View>
      ...
      <TouchableOpacity
        style={styles.addBtn}
        onPress={() => router.push('/Categories/AddExpense?defaultCategory=Giải%20Trí')}
      >
