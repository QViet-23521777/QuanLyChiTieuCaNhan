        ...
        <SafeAreaProvider>
            <Tabs
                ...
                <Tabs.Screen
                    ...
                    options={{
                        title: 'Balance',
                        tabBarIcon: ({ color }) => <MaterialCommunityIcons name="bank-transfer" size={28} color={color} />,
                    }}/>
                <Tabs.Screen
                    name="categories"
                    options={{
                        title: 'Categories',
                        tabBarIcon: ({ color }) => <MaterialCommunityIcons name="layers-outline" size={28} color={color} />,
                    }}/>
                <Tabs.Screen
                    name="profile"
                    options={{
